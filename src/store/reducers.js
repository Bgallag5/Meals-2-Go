...
// //reducer slice - a piece of our overall reducer, to be passed into combineRedcuers({})
...
// //ACTIONS
// //(cart.actions is actually cart.reducers? makes no sense but thats what it is)
// const { toggleCart, addItem } = cart.actions;

// //toggle cart visibility 
// export const handleToggleCart = () => async (dispatch) => {
//   dispatch(toggleCart());
// };
